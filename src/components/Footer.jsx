      ...
      <div className="footer-container">
        <div className="footer-content">
          <div className="footer-section">
            <h3 className="footer-title">GunMatrix</h3>
            <p className="footer-description">
              Professional Shooting Academy dedicated to nurturing skill, discipline, and confidence through the sport of shooting.
            </p>
            <div className="social-links">
              <a 
                href="https://instagram.com/gunmatrix" 
                target="_blank" 
        ...
        <div className="footer-bottom">
          <p>&copy; {new Date().getFullYear()} GunMatrix. All rights reserved.</p>
